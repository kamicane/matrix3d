...
var DecomposedMatrix = prime({
  ...
  interpolate: function(to, delta) {
    var scale1 = delta;
    var scale2 = 1 - delta;
    var perspective = to.perspective.combine(this.perspective, scale1, scale2);
    var translate = to.translate.combine(this.translate, scale1, scale2);
    var quaternion = this.quaternion.slerp(to.quaternion, delta);
    var skew = to.skew.combine(this.skew, scale1, scale2);
    var scale = to.scale.combine(this.scale, scale1, scale2);
    return new DecomposedMatrix(perspective, translate, quaternion, skew, scale);
  },
