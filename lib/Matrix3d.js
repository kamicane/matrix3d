...
var Matrix3d = prime({
  ...
  toArray: function(places) {
    return this.is2d() ? this.toArray2d(places) : this.toArray3d(places);
  },

  toArray3d: function(places) {
    var m = places != null ? this.round(places) : this;
  ...
  toString3d: function(places) {
    return 'matrix3d(' + this.toArray3d(places).join(', ') + ')';
  },

  toString2d: function(places) {
    return  'matrix(' + this.toArray2d(places).join(', ') + ')';
  }
